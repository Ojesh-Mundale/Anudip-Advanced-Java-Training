...
/*
 * DELIMITER $$ CREATE PROCEDURE DELETE_CUSTOMER_RECORD(IN VID NUMERIC(10), OUT
 * MESSAGE VARCHAR(100))
 * 
 * BEGIN START TRANSACTION; DELETE FROM TBL_CUSTOMER WHERE C_ID = VID; COMMIT;
 * 
 * SET MESSAGE = 'Record has been deleted successfully'; END$$
 * 
